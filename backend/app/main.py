...
from app.routers import matters, documents, timeline, export, research
...
# CORS — allow only Vercel frontend origins
app.add_middleware(
    CORSMiddleware,
    allow_origin_regex=r"https://.*\.vercel\.app",  # Matches any subdomain on vercel.app
